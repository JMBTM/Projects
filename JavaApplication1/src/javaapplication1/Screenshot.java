...
public class Screenshot {
    ...
    public void shotAndSaveOriginal() throws Exception //Screenshot processing
    {
        ...
        ImageIO.write(capture, "JPG", new File("C:/Users/OJT/workspace/img.jpg")); // File Location to save
    }
    
    public void compressImage() throws Exception{
        File input = new File("C:/Users/OJT/workspace/img.jpg"); //Location of the captured image
        BufferedImage image = ImageIO.read(input); //Image reading

        File compressedImageFile = new File("C:/Users/OJT/workspace/compress.jpg");//Future File Location to be saved
    ...
    public void incompressImage() throws Exception{
